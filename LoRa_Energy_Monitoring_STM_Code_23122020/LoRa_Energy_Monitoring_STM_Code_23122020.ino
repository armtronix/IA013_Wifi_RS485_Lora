...
/* Check if there is not a current TX/RX job running. */
   if(LMIC.opmode & OP_TXRXPEND) 
   ...
   else 
    {
      ...
      state = "V_C_P_E_F_PF:," + String(watts_total) + "," + String(watts_r_phase) + "," + String(watts_y_phase) + "," + String(watts_b_phase) + "," + String(var_total) + "," 
              + String(var_r_phase) + "," + String(var_y_phase) + "," + String(var_b_phase) + "," + String(pf_average) + "," + String(pf_r_phase) + "," + String(pf_y_phase) + ","
              + String(pf_b_phase) + "," + String(va_total) + "," + String(va_r_phase) + "," + String(va_y_phase) + "," + String(va_b_phase) + "," + String(vll_average) + "," + String(vry_phase) + "," + String(vyb_phase) + ","
              + String(vbr_phase) + "," + String(vln_average) + "," + String(v_r_phase) + "," + String(v_y_phase) + "," + String(v_b_phase) + "," + String(current_total) + "," + String(current_r_phase) + "," + String(current_y_phase) + ","
              + String(current_b_phase) + "," + String(frequency) + "," + String(wh_received);
 
 //    state = "V_C_P_E_F_PF:," + String(vry_phase) + "," + String(current_r_phase) + "," + String(watts_r_phase) + "," + String(wh_received) + "," + String(frequency) + "," + String(pf_r_phase); 
